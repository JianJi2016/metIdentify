# setwd("E:/project/si_wu/1stLayer_annotation_PE/RPLC_pos/MONA/NCE50")
...
# ce = "all"
# #
# result.mona.pos50 <- metIdentify(ms1.data = ms1.data,
#                                  ms2.data = ms2.data,
...
#                                  column = column)
# 
# save(result.mona.pos50, file = "result.mona.pos50")
# 
# load(database)
# ms2plot(object = result.mona.pos50, 
#         database = monaDatabase0.0.1, 
...
# result.mz.pos <- mzIdentify(ms1.data = "ms1.peak.table.csv", ms1.match.ppm = 25,
#                             polarity = "positive", column = "rp", path = ".", candidate.num = 3, 
#                             database = "HMDB.metabolite.data", threads = 5)
# 
# 
# annotation.table3 <- getIdentificationTable2(object = result.mz.pos, candidate.num = 3)
