---
title: "metIdentify version0.1.5"
author:
...
> Note:
`test.database` is only a demo database (metIdentifyClass). We will don't use it for next metabolite identification.
...
> Note:
`test.database2` is only a demo database (metIdentifyClass). We will don't use it for next metabolite identification.
